...
/*   Updated: 2019/07/11 14:43:16 by edillenb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ra_or_rra(size_t *top, size_t *top_4_5)
{
	size_t	ra_top_4;
	size_t	ra_top_5;
	size_t	rra_top_4;
	...
	ra_top_4 = top[0] - top_4_5[0] - 1;
	rra_top_4 = top_4_5[0] + 1;
	ra_top_5 = top[0] - top_4_5[1] - 1;
	rra_top_5 = top_4_5[1] + 1;
...
void		bigger_than_top_4(int *a, size_t i, int *top_5)
{
	if (a[i] > top_5[1])
	{
		top_5[4] = top_5[3];
